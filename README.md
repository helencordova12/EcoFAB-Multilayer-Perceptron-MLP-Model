...
This project presents a lightweight alternative using a Multi-Layer Perceptron (MLP) that simplifies the model-building process and enables efficient training on standard hardware.
